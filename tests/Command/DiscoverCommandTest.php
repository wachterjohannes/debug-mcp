...
class DiscoverCommandTest extends TestCase
{
    ...
    public function testDiscoversExtensionsAndCreatesFile(): void
    {
    ...
    public function testPreservesExistingEnabledState(): void
    {
        $tempDir = sys_get_temp_dir().'/mate-discover-test-'.uniqid();
...
PHP
    ...
    public function testNewPackagesDefaultToEnabled(): void
    {
        $tempDir = sys_get_temp_dir().'/mate-discover-test-'.uniqid();
        mkdir($tempDir.'/.mate', 0755, true);
...
PHP
    ...
    public function testDisplaysWarningWhenNoExtensionsFound(): void
    {
        $tempDir = sys_get_temp_dir().'/mate-discover-test-'.uniqid();
        mkdir($tempDir, 0755, true);
